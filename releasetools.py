...
def FullOTA_InstallEnd(info):
  ...
  info.script.AppendExtra('ifelse(is_substring("G900J", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox cp /system/lib/cdma/* /system/lib/"));')
  info.script.AppendExtra('ifelse(is_substring("G900J", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox cp /system/lib/hw/spr/* /system/lib/hw/"));')
